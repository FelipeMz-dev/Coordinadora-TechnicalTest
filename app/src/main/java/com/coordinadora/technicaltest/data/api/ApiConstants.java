...
public class ApiConstants {
    ...
    public static final String KEY_CORRECT = "Correcto";
    public static final String KEY_DATA = "data";
    public static final String KEY_CORRECT_STRUCTURE = "estructura Correcta";
    public static final String KEY_INCORRECT_STRUCTURE = "estructura Incorrecta";
}